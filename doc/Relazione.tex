...
\subsection{Requisiti richiesti extra}
Onestamente abbiamo avuto problemi a comprendere la natura di alcune richieste qui sotto specifichiamo come abbiamo interpretato i diversi punti:
\begin{itemize}
	...
	Inoltre si parla di virtual currency (cosa che è già presente di base in monopoly)
	Abbiamo pensato fosse un errore legato a un progetto di risiko.
